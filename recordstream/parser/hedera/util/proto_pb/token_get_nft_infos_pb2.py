...
_TOKENGETNFTINFOSQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TokenGetNftInfosQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tokenID",
            full_name="proto.TokenGetNftInfosQuery.tokenID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="start",
            full_name="proto.TokenGetNftInfosQuery.start",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="proto.TokenGetNftInfosQuery.end",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
_TOKENGETNFTINFOSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TokenGetNftInfosResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tokenID",
            full_name="proto.TokenGetNftInfosResponse.tokenID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="nfts",
            full_name="proto.TokenGetNftInfosResponse.nfts",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
TokenGetNftInfosQuery = _reflection.GeneratedProtocolMessageType(
...
TokenGetNftInfosResponse = _reflection.GeneratedProtocolMessageType(
