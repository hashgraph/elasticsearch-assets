...
_TRANSACTIONGETRECEIPTQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TransactionGetReceiptQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transactionID",
            full_name="proto.TransactionGetReceiptQuery.transactionID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionGetReceiptQuery.includeDuplicates",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="include_child_receipts",
            full_name="proto.TransactionGetReceiptQuery.include_child_receipts",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_TRANSACTIONGETRECEIPTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TransactionGetReceiptResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="receipt",
            full_name="proto.TransactionGetReceiptResponse.receipt",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="duplicateTransactionReceipts",
            full_name="proto.TransactionGetReceiptResponse.duplicateTransactionReceipts",
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="child_transaction_receipts",
            full_name="proto.TransactionGetReceiptResponse.child_transaction_receipts",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
...
_TRANSACTIONGETRECEIPTRESPONSE.fields_by_name[
    "duplicateTransactionReceipts"
].message_type = transaction__receipt__pb2._TRANSACTIONRECEIPT
_TRANSACTIONGETRECEIPTRESPONSE.fields_by_name[
...
TransactionGetReceiptQuery = _reflection.GeneratedProtocolMessageType(
...
TransactionGetReceiptResponse = _reflection.GeneratedProtocolMessageType(
