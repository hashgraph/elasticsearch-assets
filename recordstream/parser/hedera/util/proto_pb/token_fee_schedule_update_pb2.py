...
_TOKENFEESCHEDULEUPDATETRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token_id",
            full_name="proto.TokenFeeScheduleUpdateTransactionBody.token_id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="custom_fees",
            full_name="proto.TokenFeeScheduleUpdateTransactionBody.custom_fees",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
TokenFeeScheduleUpdateTransactionBody = _reflection.GeneratedProtocolMessageType(
