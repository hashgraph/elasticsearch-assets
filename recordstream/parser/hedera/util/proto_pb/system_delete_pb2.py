...
_SYSTEMDELETETRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="fileID",
            full_name="proto.SystemDeleteTransactionBody.fileID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="contractID",
            full_name="proto.SystemDeleteTransactionBody.contractID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="expirationTime",
            full_name="proto.SystemDeleteTransactionBody.expirationTime",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="id",
            full_name="proto.SystemDeleteTransactionBody.id",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_SYSTEMDELETETRANSACTIONBODY.oneofs_by_name["id"].fields.append(_SYSTEMDELETETRANSACTIONBODY.fields_by_name["fileID"])
_SYSTEMDELETETRANSACTIONBODY.fields_by_name["fileID"].containing_oneof = _SYSTEMDELETETRANSACTIONBODY.oneofs_by_name[
    "id"
]
_SYSTEMDELETETRANSACTIONBODY.oneofs_by_name["id"].fields.append(
    _SYSTEMDELETETRANSACTIONBODY.fields_by_name["contractID"]
)
_SYSTEMDELETETRANSACTIONBODY.fields_by_name["contractID"].containing_oneof = _SYSTEMDELETETRANSACTIONBODY.oneofs_by_name[
    "id"
]
DESCRIPTOR.message_types_by_name["SystemDeleteTransactionBody"] = _SYSTEMDELETETRANSACTIONBODY
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

SystemDeleteTransactionBody = _reflection.GeneratedProtocolMessageType(
