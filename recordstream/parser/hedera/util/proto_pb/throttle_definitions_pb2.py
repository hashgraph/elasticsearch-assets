...
_THROTTLEGROUP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="operations",
            full_name="proto.ThrottleGroup.operations",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="milliOpsPerSec",
            full_name="proto.ThrottleGroup.milliOpsPerSec",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
_THROTTLEBUCKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="proto.ThrottleBucket.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="burstPeriodMs",
            full_name="proto.ThrottleBucket.burstPeriodMs",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="throttleGroups",
            full_name="proto.ThrottleBucket.throttleGroups",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_THROTTLEDEFINITIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="throttleBuckets",
            full_name="proto.ThrottleDefinitions.throttleBuckets",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
ThrottleGroup = _reflection.GeneratedProtocolMessageType(
    "ThrottleGroup",
    (_message.Message,),
    {
...
ThrottleBucket = _reflection.GeneratedProtocolMessageType(
    "ThrottleBucket",
    (_message.Message,),
    {
...
ThrottleDefinitions = _reflection.GeneratedProtocolMessageType(
    "ThrottleDefinitions",
    (_message.Message,),
    {
