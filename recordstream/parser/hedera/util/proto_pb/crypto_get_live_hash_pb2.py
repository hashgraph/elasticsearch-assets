...
_CRYPTOGETLIVEHASHQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetLiveHashQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.CryptoGetLiveHashQuery.accountID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="hash",
            full_name="proto.CryptoGetLiveHashQuery.hash",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
_CRYPTOGETLIVEHASHRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetLiveHashResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="liveHash",
            full_name="proto.CryptoGetLiveHashResponse.liveHash",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
CryptoGetLiveHashQuery = _reflection.GeneratedProtocolMessageType(
...
CryptoGetLiveHashResponse = _reflection.GeneratedProtocolMessageType(
