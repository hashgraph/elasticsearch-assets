...
_FILEGETINFOQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.FileGetInfoQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fileID",
            full_name="proto.FileGetInfoQuery.fileID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FILEGETINFORESPONSE_FILEINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="fileID",
            full_name="proto.FileGetInfoResponse.FileInfo.fileID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="size",
            full_name="proto.FileGetInfoResponse.FileInfo.size",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="expirationTime",
            full_name="proto.FileGetInfoResponse.FileInfo.expirationTime",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="deleted",
            full_name="proto.FileGetInfoResponse.FileInfo.deleted",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="keys",
            full_name="proto.FileGetInfoResponse.FileInfo.keys",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="proto.FileGetInfoResponse.FileInfo.memo",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ledger_id",
            full_name="proto.FileGetInfoResponse.FileInfo.ledger_id",
            index=6,
            number=7,
            type=12,
            cpp_type=9,
...
_FILEGETINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.FileGetInfoResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
FileGetInfoQuery = _reflection.GeneratedProtocolMessageType(
    "FileGetInfoQuery",
    (_message.Message,),
    {
...
FileGetInfoResponse = _reflection.GeneratedProtocolMessageType(
    "FileGetInfoResponse",
    (_message.Message,),
    {
