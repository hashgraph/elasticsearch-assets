...
_FILEAPPENDTRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="fileID",
            full_name="proto.FileAppendTransactionBody.fileID",
            index=0,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="contents",
            full_name="proto.FileAppendTransactionBody.contents",
            index=1,
            number=4,
            type=12,
            cpp_type=9,
...
FileAppendTransactionBody = _reflection.GeneratedProtocolMessageType(
