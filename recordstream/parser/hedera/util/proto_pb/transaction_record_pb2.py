...
from hedera.util.proto_pb import custom_fees_pb2 as custom__fees__pb2
from hedera.util.proto_pb import timestamp_pb2 as timestamp__pb2
from hedera.util.proto_pb import transaction_receipt_pb2 as transaction__receipt__pb2
...
_TRANSACTIONRECORD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="receipt",
            full_name="proto.TransactionRecord.receipt",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionRecord.transactionHash",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionRecord.consensusTimestamp",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transactionID",
            full_name="proto.TransactionRecord.transactionID",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="proto.TransactionRecord.memo",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="transactionFee",
            full_name="proto.TransactionRecord.transactionFee",
            index=5,
            number=6,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionRecord.contractCallResult",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionRecord.contractCreateResult",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transferList",
            full_name="proto.TransactionRecord.transferList",
            index=8,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tokenTransferLists",
            full_name="proto.TransactionRecord.tokenTransferLists",
            index=9,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="scheduleRef",
            full_name="proto.TransactionRecord.scheduleRef",
            index=10,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="assessed_custom_fees",
            full_name="proto.TransactionRecord.assessed_custom_fees",
            index=11,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="automatic_token_associations",
            full_name="proto.TransactionRecord.automatic_token_associations",
            index=12,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionRecord.parent_consensus_timestamp",
            index=13,
            number=15,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="alias",
            full_name="proto.TransactionRecord.alias",
            index=14,
            number=16,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ethereum_hash",
            full_name="proto.TransactionRecord.ethereum_hash",
            index=15,
            number=17,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="paid_staking_rewards",
            full_name="proto.TransactionRecord.paid_staking_rewards",
            index=16,
            number=18,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="body",
            full_name="proto.TransactionRecord.body",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_TRANSACTIONRECORD.fields_by_name[
    "contractCreateResult"
].message_type = contract__call__local__pb2._CONTRACTFUNCTIONRESULT
...
_TRANSACTIONRECORD.fields_by_name["paid_staking_rewards"].message_type = basic__types__pb2._ACCOUNTAMOUNT
_TRANSACTIONRECORD.oneofs_by_name["body"].fields.append(_TRANSACTIONRECORD.fields_by_name["contractCallResult"])
_TRANSACTIONRECORD.fields_by_name["contractCallResult"].containing_oneof = _TRANSACTIONRECORD.oneofs_by_name["body"]
_TRANSACTIONRECORD.oneofs_by_name["body"].fields.append(_TRANSACTIONRECORD.fields_by_name["contractCreateResult"])
...
TransactionRecord = _reflection.GeneratedProtocolMessageType(
    "TransactionRecord",
    (_message.Message,),
    {
