...
_QUERYHEADER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="payment",
            full_name="proto.QueryHeader.payment",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="responseType",
            full_name="proto.QueryHeader.responseType",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
QueryHeader = _reflection.GeneratedProtocolMessageType(
    "QueryHeader",
    (_message.Message,),
    {
