...
_CRYPTOGETINFOQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetInfoQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.CryptoGetInfoQuery.accountID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CRYPTOGETINFORESPONSE_ACCOUNTINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.accountID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.CryptoGetInfoResponse.AccountInfo.contractAccountID",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="deleted",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.deleted",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="proxyAccountID",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.proxyAccountID",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="proxyReceived",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.proxyReceived",
            index=4,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="key",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.key",
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="balance",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.balance",
            index=6,
            number=8,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="generateSendRecordThreshold",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.generateSendRecordThreshold",
            index=7,
            number=9,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="generateReceiveRecordThreshold",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.generateReceiveRecordThreshold",
            index=8,
            number=10,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.CryptoGetInfoResponse.AccountInfo.receiverSigRequired",
            index=9,
            number=11,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="expirationTime",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.expirationTime",
            index=10,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.CryptoGetInfoResponse.AccountInfo.autoRenewPeriod",
            index=11,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="liveHashes",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.liveHashes",
            index=12,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tokenRelationships",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.tokenRelationships",
            index=13,
            number=15,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.memo",
            index=14,
            number=16,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ownedNfts",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.ownedNfts",
            index=15,
            number=17,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.CryptoGetInfoResponse.AccountInfo.max_automatic_token_associations",
            index=16,
            number=18,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="alias",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.alias",
            index=17,
            number=19,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ledger_id",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.ledger_id",
            index=18,
            number=20,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ethereum_nonce",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.ethereum_nonce",
            index=19,
            number=21,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="staking_info",
            full_name="proto.CryptoGetInfoResponse.AccountInfo.staking_info",
            index=20,
            number=22,
            type=11,
            cpp_type=10,
...
_CRYPTOGETINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetInfoResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _CRYPTOGETINFORESPONSE_ACCOUNTINFO,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name[
    "tokenRelationships"
].message_type = basic__types__pb2._TOKENRELATIONSHIP
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name["staking_info"].message_type = basic__types__pb2._STAKINGINFO
...
CryptoGetInfoQuery = _reflection.GeneratedProtocolMessageType(
    "CryptoGetInfoQuery",
    (_message.Message,),
    {
...
CryptoGetInfoResponse = _reflection.GeneratedProtocolMessageType(
...
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name["proxyAccountID"]._options = None
