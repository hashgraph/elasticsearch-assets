...
_CONSENSUSCREATETOPICTRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="proto.ConsensusCreateTopicTransactionBody.memo",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="adminKey",
            full_name="proto.ConsensusCreateTopicTransactionBody.adminKey",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="submitKey",
            full_name="proto.ConsensusCreateTopicTransactionBody.submitKey",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.ConsensusCreateTopicTransactionBody.autoRenewPeriod",
            index=3,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.ConsensusCreateTopicTransactionBody.autoRenewAccount",
            index=4,
            number=7,
            type=11,
            cpp_type=10,
...
ConsensusCreateTopicTransactionBody = _reflection.GeneratedProtocolMessageType(
