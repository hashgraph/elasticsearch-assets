...
_CONSENSUSTOPICINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="proto.ConsensusTopicInfo.memo",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="runningHash",
            full_name="proto.ConsensusTopicInfo.runningHash",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="sequenceNumber",
            full_name="proto.ConsensusTopicInfo.sequenceNumber",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="expirationTime",
            full_name="proto.ConsensusTopicInfo.expirationTime",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="adminKey",
            full_name="proto.ConsensusTopicInfo.adminKey",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="submitKey",
            full_name="proto.ConsensusTopicInfo.submitKey",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.ConsensusTopicInfo.autoRenewPeriod",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.ConsensusTopicInfo.autoRenewAccount",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ledger_id",
            full_name="proto.ConsensusTopicInfo.ledger_id",
            index=8,
            number=9,
            type=12,
            cpp_type=9,
...
ConsensusTopicInfo = _reflection.GeneratedProtocolMessageType(
    "ConsensusTopicInfo",
    (_message.Message,),
    {
