...
_TOKENMINTTRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="proto.TokenMintTransactionBody.token",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="amount",
            full_name="proto.TokenMintTransactionBody.amount",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="metadata",
            full_name="proto.TokenMintTransactionBody.metadata",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
TokenMintTransactionBody = _reflection.GeneratedProtocolMessageType(
