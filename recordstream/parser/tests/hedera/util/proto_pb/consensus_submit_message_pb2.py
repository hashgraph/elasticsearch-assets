...
_CONSENSUSMESSAGECHUNKINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.ConsensusMessageChunkInfo.initialTransactionID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="total",
            full_name="proto.ConsensusMessageChunkInfo.total",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="number",
            full_name="proto.ConsensusMessageChunkInfo.number",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_CONSENSUSSUBMITMESSAGETRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="topicID",
            full_name="proto.ConsensusSubmitMessageTransactionBody.topicID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="proto.ConsensusSubmitMessageTransactionBody.message",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="chunkInfo",
            full_name="proto.ConsensusSubmitMessageTransactionBody.chunkInfo",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
ConsensusMessageChunkInfo = _reflection.GeneratedProtocolMessageType(
...
ConsensusSubmitMessageTransactionBody = _reflection.GeneratedProtocolMessageType(
