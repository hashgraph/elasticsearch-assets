...
from hedera.util.proto_pb import consensus_topic_info_pb2 as consensus__topic__info__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        consensus__topic__info__pb2.DESCRIPTOR,
    ],
)
...
_CONSENSUSGETTOPICINFOQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.ConsensusGetTopicInfoQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="topicID",
            full_name="proto.ConsensusGetTopicInfoQuery.topicID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CONSENSUSGETTOPICINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.ConsensusGetTopicInfoResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="topicID",
            full_name="proto.ConsensusGetTopicInfoResponse.topicID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="topicInfo",
            full_name="proto.ConsensusGetTopicInfoResponse.topicInfo",
            index=2,
            number=5,
            type=11,
            cpp_type=10,
...
ConsensusGetTopicInfoQuery = _reflection.GeneratedProtocolMessageType(
...
ConsensusGetTopicInfoResponse = _reflection.GeneratedProtocolMessageType(
