...
_CRYPTOTRANSFERTRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="transfers",
            full_name="proto.CryptoTransferTransactionBody.transfers",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tokenTransfers",
            full_name="proto.CryptoTransferTransactionBody.tokenTransfers",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
CryptoTransferTransactionBody = _reflection.GeneratedProtocolMessageType(
