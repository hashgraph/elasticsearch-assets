...
_TRANSACTIONGETFASTRECORDQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TransactionGetFastRecordQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transactionID",
            full_name="proto.TransactionGetFastRecordQuery.transactionID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_TRANSACTIONGETFASTRECORDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.TransactionGetFastRecordResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="proto.TransactionGetFastRecordResponse.transactionRecord",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_TRANSACTIONGETFASTRECORDRESPONSE.fields_by_name[
    "transactionRecord"
...
TransactionGetFastRecordQuery = _reflection.GeneratedProtocolMessageType(
...
TransactionGetFastRecordResponse = _reflection.GeneratedProtocolMessageType(
