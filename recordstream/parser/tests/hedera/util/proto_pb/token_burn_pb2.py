...
_TOKENBURNTRANSACTIONBODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="proto.TokenBurnTransactionBody.token",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="amount",
            full_name="proto.TokenBurnTransactionBody.amount",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="serialNumbers",
            full_name="proto.TokenBurnTransactionBody.serialNumbers",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
TokenBurnTransactionBody = _reflection.GeneratedProtocolMessageType(
