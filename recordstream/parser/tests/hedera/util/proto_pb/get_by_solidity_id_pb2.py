...
_GETBYSOLIDITYIDQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.GetBySolidityIDQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="solidityID",
            full_name="proto.GetBySolidityIDQuery.solidityID",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_GETBYSOLIDITYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.GetBySolidityIDResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.GetBySolidityIDResponse.accountID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fileID",
            full_name="proto.GetBySolidityIDResponse.fileID",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="contractID",
            full_name="proto.GetBySolidityIDResponse.contractID",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
GetBySolidityIDQuery = _reflection.GeneratedProtocolMessageType(
...
GetBySolidityIDResponse = _reflection.GeneratedProtocolMessageType(
