...
_CRYPTOGETSTAKERSQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetStakersQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.CryptoGetStakersQuery.accountID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PROXYSTAKER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.ProxyStaker.accountID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="amount",
            full_name="proto.ProxyStaker.amount",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_ALLPROXYSTAKERS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="accountID",
            full_name="proto.AllProxyStakers.accountID",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="proxyStaker",
            full_name="proto.AllProxyStakers.proxyStaker",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CRYPTOGETSTAKERSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.CryptoGetStakersResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="stakers",
            full_name="proto.CryptoGetStakersResponse.stakers",
            index=1,
            number=3,
            type=11,
            cpp_type=10,
...
CryptoGetStakersQuery = _reflection.GeneratedProtocolMessageType(
...
ProxyStaker = _reflection.GeneratedProtocolMessageType(
    "ProxyStaker",
    (_message.Message,),
    {
...
AllProxyStakers = _reflection.GeneratedProtocolMessageType(
    "AllProxyStakers",
    (_message.Message,),
    {
...
CryptoGetStakersResponse = _reflection.GeneratedProtocolMessageType(
