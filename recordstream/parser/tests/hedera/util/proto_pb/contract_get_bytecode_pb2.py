...
_CONTRACTGETBYTECODEQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.ContractGetBytecodeQuery.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="contractID",
            full_name="proto.ContractGetBytecodeQuery.contractID",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CONTRACTGETBYTECODERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="proto.ContractGetBytecodeResponse.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="bytecode",
            full_name="proto.ContractGetBytecodeResponse.bytecode",
            index=1,
            number=6,
            type=12,
            cpp_type=9,
...
ContractGetBytecodeQuery = _reflection.GeneratedProtocolMessageType(
...
ContractGetBytecodeResponse = _reflection.GeneratedProtocolMessageType(
